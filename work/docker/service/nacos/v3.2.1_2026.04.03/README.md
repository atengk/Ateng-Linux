...
```
docker pull nacos/nacos-server:v3.2.1-2026.04.03
```

**推送到仓库**

```
docker tag nacos/nacos-server:v3.2.1-2026.04.03 registry.lingo.local/service/nacos-server:v3.2.1-2026.04.03
docker push registry.lingo.local/service/nacos-server:v3.2.1-2026.04.03
```

**保存镜像**

```
docker save registry.lingo.local/service/nacos-server:v3.2.1-2026.04.03 | gzip -c > image-nacos-server_v3.2.1-2026.04.03.tar.gz
```
...
docker run -d --name ateng-nacos --user 1001 \
  ...
  -e JVM_XMX=2g \
  -e TZ=Asia/Shanghai \
  registry.lingo.local/service/nacos-server:v3.2.1-2026.04.03
```
...
![image-20260409161400744](./assets/image-20260409161400744.png)

Nacos 首页

![image-20260409161421179](./assets/image-20260409161421179.png)
