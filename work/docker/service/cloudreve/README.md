...
```
docker pull cloudreve/cloudreve:4.6.0
```

**推送到仓库**

```
docker tag cloudreve/cloudreve:4.6.0 registry.lingo.local/service/cloudreve:4.6.0
docker push registry.lingo.local/service/cloudreve:4.6.0
```

**保存镜像**

```
docker save registry.lingo.local/service/cloudreve:4.6.0 | gzip -c > image-cloudreve_4.6.0.tar.gz
```
...
docker run -d --name ateng-cloudreve \
  ...
  registry.lingo.local/service/cloudreve:4.6.0
```
...
![image-20250829153719610](./assets/image-20250829153719610.png)

![image-20250829153745382](./assets/image-20250829153745382.png)
