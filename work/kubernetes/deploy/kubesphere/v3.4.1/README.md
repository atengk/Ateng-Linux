...
将下载的镜像推送到镜像仓库中，可以参考安装[registry](/work/kubernetes/deploy/harbor/registry/README)或者[harbor](/work/kubernetes/deploy/harbor/v2.11.1/README)仓库
...
> 存储类安装参考[openebs-hostpath](/work/kubernetes/deploy/storage/openebs/local/README)
