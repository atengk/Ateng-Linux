...
```
export https_proxy=http://10.244.250.100:7890
```
...
```
make PREFIX=/usr/local/software/redis-8.2.2-openeuler install
cp *.conf /usr/local/software/redis-8.2.2-openeuler
```
...
```
make PREFIX=/usr/local/software/redis-8.2.2-rockylinux install
cp *.conf /usr/local/software/redis-8.2.2-rockylinux
```
...
```
make PREFIX=/usr/local/software/redis-8.2.2-almalinux install
cp *.conf /usr/local/software/redis-8.2.2-almalinux
```
...
```
make PREFIX=/usr/local/software/redis-8.2.2-debian install
cp *.conf /usr/local/software/redis-8.2.2-debian
```
...
```
make PREFIX=/usr/local/software/redis-8.2.2-ubuntu install
cp *.conf /usr/local/software/redis-8.2.2-ubuntu
```
