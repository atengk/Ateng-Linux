...
- [基础配置](/work/service/00-basic/README.md)

- [编译软件包](/work/service/redis/v8.2.2/BUILD.md)
...
```bash
cp -r /usr/local/software/redis-8.2.2-openeuler /usr/local/software/redis-8.2.2
ln -s /usr/local/software/redis-8.2.2 /usr/local/software/redis
```
