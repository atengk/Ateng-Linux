...
由 **[OpenTelemetry Collector](/work/service/opentelemetry/README)** 将 `traces` 和 `metrics` 数据推送到 Jaeger，Jaeger配置prometheus指标，在prometheus中配置该指标拉取数据。

**Otel配置**

在 **[OpenTelemetry Collector](/work/service/opentelemetry/README)** 中将 `metrics` 也推送一份数据到 Jaeger 中，配置文件关键部分如下：
...
- [官网文档](https://www.jaegertracing.io/docs/2.4/badger/)
- [Github文件参考](https://github.com/jaegertracing/jaeger/blob/v2.4.0/cmd/jaeger/config-badger.yaml)
- [安装文档](/work/kubernetes/service/cassandra/v5.0.3/README)
